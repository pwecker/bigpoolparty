<template>
    ...
    <div @click="_tag" class="fixed bottom-0 left-[0] bg-zinc-100 z-1 pr-2 pl-2 rounded-lg m-4 border-1 border-solid cursor-pointer hover:bg-white">Download Tag</div>
